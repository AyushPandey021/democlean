  ...
  return (
    <header className={`navbar ${isScrolled ? "navbar--scrolled" : ""}`}>
      <div className="navbar__notice">
        Powerful cleaning. Complete protection. Made in India.
      </div>
      <div className="navbar__inner container">
        ...
        <nav
          className={`navbar__nav ${isMobileOpen ? "navbar__nav--open" : ""}`}
        ...
        >
          ...
          <a
            ...
            href={config.getWhatsAppUrl(
              "Hi DEMOCLEAN, I would like to know more about your products.",
            )}
            target="_blank"
            rel="noreferrer"
          >
